#JIBON(MD HRUDOY KHAN)(JIBONKHAN104)
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/JIBONkhan104/game.py/main/game.txt').text
...
╚╝──╚═══╩═══╩╝╚═╩═══╩╝╚═╝  \033[1;92m
 ...
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
  ...
  os.system(f'xdg-open https://www.facebook.com/permanent009')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/JIBON-XD-FUCKER-2005/free-basic/blob/main/free.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801867341765?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/permanent009');time.sleep(1)
		admin()
	if bal =='3':
